...
rule simulate_psf:
    input:
        ...
        asolfile="results/{config_name}/{obs_id}/repro/simulate-psf-asol-{obs_id}.fits"
    output:
    ...
    shell:
        ...
        'simulate_psf infile={input.infile} outroot={params.outroot} spectrum={input.spectrum} asolfile={input.asolfile} {params.args}'
